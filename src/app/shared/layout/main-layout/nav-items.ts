...
export const NAV_ITEMS: NavItem[] = [
  { label: "Dashboard", path: "/dashboard" },
  {
    ...
    path: "/dashboard/approval-report",
  ...
  {
    label: "Disbursement",
    path: "/disbursement/accounting",
    roles: ["FinanceViewer", "Admin"],
  },
  {
    label: "Procurement",
    path: "/procurement",
    roles: ["Requester", "Approver", "FinanceViewer", "Admin"],
  },
  {
    label: "Reimbursements",
    path: "/reimbursements",
    roles: ["Requester", "FinanceViewer", "Admin"],
  },

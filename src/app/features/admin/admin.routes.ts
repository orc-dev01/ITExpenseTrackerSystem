...
export const ADMIN_ROUTES: Routes = [
  { path: 'approval-matrix', component: FeaturePage, data: { title: 'Approval Matrix', subtitle: 'Configurable endorser and approver routing by amount, department, and category.', mockKey: 'approvalMatrix', primaryAction: 'Add Rule', roles, capabilities: ['Admin configures endorser and approver assignments.', 'Rules can vary by department, amount range, and category.', 'High-value requests can require secondary approval.', 'Emergency route can bypass endorsement with audit note.'], endpoints: [ApiEndpoints.admin.approvalMatrix] } },
